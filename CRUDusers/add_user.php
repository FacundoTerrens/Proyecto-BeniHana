...
<body data-theme="dark">
    <?php
        ...
        $queri=mysqli_query($conexion, "SELECT ID FROM articulo ORDER BY ID DESC LIMIT 0, 1");
            ...
            <div class="page-content container-fluid">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title text-uppercase mb-0">Agregar Articulo</h5>
                            </div>
                                ...
                                <table class="table no-wrap user-table mb-0">
                                  <thead>
                                    <tr>
                                        ...
                                        <th scope="col" class="border-0 text-uppercase font-medium">Fotos</th>
                                        <th scope="col" class="border-0 text-uppercase font-medium">Opciones</th>
                                    </tr>
                                  </thead>
                                  <tbody>
                                    <form action="C_user_mysql.php" method="post" enctype="multipart/form-data">
                                        <tr>
                                        <td class="pl-4"><?php echo $id;?></td> 
                                        <?php echo '<input type="text" value="'.$id.'" name="id" id="inp">' ?>  
                                        <td>
                                            <label for="inp" class="inp">
                                                <input type="text" value="" name="nombre" id="inp" placeholder="Nombre del articulo">
                                        ...
                                        <td>
                                            ...
                                            <select name="categoria" class="form-control category-select" id="exampleFormControlSelect1">
                                                ...
                                                <option value="Indumentaria para empresas">Indumentaria para empresas</option>
                                            </select>
                                        </td><td>
                                        ...
                                        <td>
                                            <label for="inp" class="inp">
                                                $&nbsp&nbsp<input type="text" value="" name="precio" id="inp" placeholder="Ej: 3200.35">
                                                <span class="label"></span>
                                                <span class="border"></span>
                                            </label>
