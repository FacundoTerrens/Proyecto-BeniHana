            ...
            <div class="page-content container-fluid">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title text-uppercase mb-0">Manejar Articulos</h5>
                            </div>
                                ...
                                <table class="table no-wrap user-table mb-0 sortable">
                                  ...
                                  <tbody>
                                    <?php
                                        ...
                                        $query = mysqli_query($conexion, "SELECT * FROM articulo LIMIT $cuenta, $tam");
                                    ...
                                    echo '<tr>
                                        ...
                                        <td>
                                            <h5 class="font-medium mb-0">'. $row['Nombre'].'</h5>
                                        </td>
                                        <td>
                                            <span class="text-muted">'. $row['Tipo'].'</span>
                                        </td>
                                        ...
                                        <td>
                                            <span class="text-muted">'. $row['Talle'].'</span>
                                        </td>
                                        
                                        <td>
                                            <span class="text-muted">'. $row['Color'].'</span>
                                        </td>
                                        
                                        <td>
                                            <span class="text-muted">'. $row['Genero'].'</span>
                                        </td>
                                        
                                        <td>
                                            <span class="text-muted">$'. $row['Precio'].'</span>
                                        </td>
                                        <td>';
                                    if ($row['tf_activo']==1) {
                        ...
                        <a href="CRUDusers/add_user.php"><button class="btn btn-danger text-white float-right ml-3 d-none d-md-block">Nuevo Articulo</button></a>
                    </div>
                </div>
            </div>  
